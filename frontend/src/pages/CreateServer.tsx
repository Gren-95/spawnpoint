...
import { Server, Upload, Archive, ChevronLeft, Package } from 'lucide-react';
...
type Mode = 'pick' | 'new' | 'prism' | 'mrpack' | 'backup';
    ...
    <div className="p-6 max-w-2xl">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        >
          ...
          <div>
            <div className="font-semibold text-gray-100 group-hover:text-mc-green transition-colors">Import Modrinth Pack</div>
